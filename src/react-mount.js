...
function getNodes(tags, context) {
    ...
    for (let i = 0; i<keys.length; i++) keys[i]=keys[i].toUpperCase();
...
export default function mount(tags, opts){
    opts = opts || {};
